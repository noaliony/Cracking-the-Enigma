...
public class MachineBuilder {
    ...
    public Machine createMachineFromInputStream(InputStream inputStream) {
        CTEEnigma cteEnigma = ReadXML.getCteEnigmaFromInputStream(inputStream);

        return createMachineFromCTEEnigma(cteEnigma);
    }
    ...
    public Machine createMachineFromCTEEnigma(CTEEnigma cteEnigma) {
        ...
        String gameLevelString = cteEnigma.getCTEBattlefield().getLevel().trim();
